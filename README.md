...
Static export of the **Trevillyan Labs** website from Webflow. The site is for a research and development company that invents and licenses technologies. CMS-style content is provided by `data/*.json` and rendered client-side; the contact form posts to a Vercel serverless function and is protected by Cloudflare Turnstile against bots.
